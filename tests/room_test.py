...
class TestRoom(unittest.TestCase):
    def setUp(self):
        ...
        self.guest_1 = Guest("Garry")
        self.guest_2 = Guest("Helen")
        self.guest_3 = Guest("Bob")
        self.guest_4 = Guest("Bill")
        self.guest_5 = Guest("Dave")
        self.guest_in_room_1 = Guest("Mark")
        self.guest_in_room_2 = Guest("Steve")
